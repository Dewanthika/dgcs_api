...
export class CreateUserDto {
  ...
  @IsDate() @IsOptional() DOB?: Date;
  @IsString() @IsOptional() address?: AddressDto;
  @IsString() @IsOptional() phone?: string;
  @IsString() @IsNotEmpty() password: string;
  @IsString() @IsOptional() companyID?: CreateCompanyDto | Types.ObjectId;
  @IsString() @IsNotEmpty() userTypeID: CreateUserTypeDto | Types.ObjectId;
}
